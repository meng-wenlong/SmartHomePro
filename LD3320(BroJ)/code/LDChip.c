...
#define DATE_B 20		/*数组一维数值*/
  ...
  {
    "hei ji ge",\	
    "jiang di yu zhi",\				//降低阈值 1
    "ti gao yu zhi",\					//提高阈值 2
    "xian shi wen du",\				//显示温度 3
    "xian shi shi du",\				//显示湿度 4
    "xian shi guang qiang",\	//显示光强 5
    "quan bu xian shi",\			//全部显示 6
    "xi ping",\								//息屏     7
    "wai bi ba bo",\					//降低五度 8
    "chong she yu zhi",\			//提高五度 9
    "quan bu guan bi",\
  };	/*添加关键词，用户修改*/
