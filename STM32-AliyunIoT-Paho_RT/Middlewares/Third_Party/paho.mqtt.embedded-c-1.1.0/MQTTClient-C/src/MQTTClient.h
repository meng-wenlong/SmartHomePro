...
#include "stdio.h"
#include "paho_mqtt_platform.h"//@sz
...
enum returnCode { TIMEOUT = -3, BUFFER_OVERFLOW = -2, FAILURE = -1, MQSUCCESS = 0 };   //@sz add TIMEOUT
 ...
 */
DLLExport int MQTTIsConnected(MQTTClient* client); //@sz
